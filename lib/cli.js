...
var baseCommands = {
  ...
  sync: {
    desc: 'synchronize outpost with homebase',
    help: '',
    process: function(action, options) {
      return {
        type: 'sync'
  ...
  module: {
    ...
    options: {
      dir: {
        desc: 'the module directory to pack. this directory is expected to contain a module.json file',
        required: ['pack'], // this options is required
        type: 'string'
      },
      out: {
        desc: 'the directory where the output module is to be written',
        required: ['pack'], // this options is required
        type: 'string'
      },
      platform: {
