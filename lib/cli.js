...
var baseCommands = {
  ...
  state: {
    ...
    options: {
      state: {
        ...
        required: true, // this options is required
        type: 'string'
      }
    },
  ...
  agent: {
    ...
    options: {
      ...
      output: {
        desc: 'file to save the configuration during init',
        required: ['init'], // this option is required for the 'init' action only
        type: 'string'
      }
    },
    process: function(action, options) {
