...
var baseCommands = {
  ...
  install: {
    ...
    help: 'Installing a module requires specifying a full module name or url',
    options: {
      config: {
  ...
  uninstall: {
    ...
    usage: '<module> [options]',
    help: 'Uninstalling a module requires specifying a module name',
    options: {
      config: {
