 ...
 * The outpost agent
 * @param config
 *    key - the identification key of this agent instance. used for communicating with homebase
 *    token - secret token for authenticating with homebase
...
Outpost.prototype.start = function(cb) {
  ...
  try {
    fs.mkdirSync(this.config.root, 0744);
  } catch(err) {
