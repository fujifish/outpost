...
outpost = {
   ...
   *  - maxUpTime - time in minutes to allow the process to run. after maxUpTime minutes elapse,
   *                the process will be restarted. default is 0 which indicates no maximum up time
